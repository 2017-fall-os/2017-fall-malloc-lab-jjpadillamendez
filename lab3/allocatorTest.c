...
int runBestFitTest(){
    ...
    p1 = bestFitAllocRegion(254);         // Allocate different regions just to set up test case
    ...
    printf(" :Initial State \n");
    p1 = bestFitAllocRegion(1900);         // Allocate different regions just to set up test case
    ...
    arenaCheck();
    printf(" :Final State \n");
    p2 = bestFitAllocRegion(2550);         // Allocate new region at p2
    arenaCheck();
    ...
    arenaCheck();
    printf(" :Final State \n");
    p1 = bestFitAllocRegion(0x200000);    // Try to allocate a huge region
    arenaCheck();
...
int runNextFitTest(){
    ...
    printf(": p1 = nextFitAllocRegion(254)   , "); printLastPrefix();   // Allocate different regions just to set up test case
    ...
    arenaCheck();
    printf(" Final State: \n");
    p4 = nextFitAllocRegion(240);                                       // Allocate new region at p4
    ...
    printf(": p1 = nextFitAllocRegion(500000) , "); printLastPrefix();   // Allocate different regions just to set up test case
    ...
    p1 = nextFitAllocRegion(0x200000);                                  // Try to allocate a huge region
    arenaCheck();
 ...
 int main(){
    ...
    cleanArena();                           // Clear arena, just for testing purposes
